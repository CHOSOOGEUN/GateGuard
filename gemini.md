...
**GitHub 레포**: https://github.com/CHOSOOGEUN/AdCatch (레포명은 아직 AdCatch, 추후 변경 예정)
...
## MCP 연동 현황 (Antigravity)

| MCP 서버 | 상태 | 비고 |
|---|---|---|
| GitHub | ✅ 연동 완료 | 토큰 유효 확인 (CHOSOOGEUN) |
| Tavily | ✅ 연동 완료 | AI 특화 검색 엔진 |
| Google Search | ✅ 연동 완료 | Custom Search Engine 설정 완료 |
| Docker | ✅ 활성화 | Docker Desktop 실행 중 |
| PostgreSQL | ⏳ 대기 | DB 구축 후 연동 예정 |
| AWS | ⏳ 대기 | 배포 단계에서 연동 예정 |
| Postman | ⏳ 대기 | API 구현 후 연동 예정 |
| Notion | ⏳ 대기 | 필요 시 연동 예정 |
| Filesystem | ✅ 설정 완료 | 프로젝트 경로 등록됨 |
...
- GitHub 레포명이 AdCatch로 되어 있지만 프로젝트명은 GateGuard로 확정됨
